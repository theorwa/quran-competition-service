...
exports.FirstAyahOfPageGenerator = void 0;
const BaseQuestionGenerator_1 = require("../BaseQuestionGenerator");
class FirstAyahOfPageGenerator extends BaseQuestionGenerator_1.BaseQuestionGenerator {
    generateQuestion(startPage, endPage) {
        ...
        return {
            question: FirstAyahOfPageGenerator.QUESTION_TEXT,
            ayah: ayah.ayahText,
    ...
    get questionText() {
        return FirstAyahOfPageGenerator.QUESTION_TEXT;
    }
}
exports.FirstAyahOfPageGenerator = FirstAyahOfPageGenerator;
FirstAyahOfPageGenerator.QUESTION_TEXT = 'ما هي الآية التي تبدأ بها الصفحة؟';
